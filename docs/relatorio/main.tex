...
\input{capitulos/cap02_estado_arte}
\input{capitulos/cap03_trabalho_relacionado}
\input{capitulos/cap04_desenho}
\input{capitulos/cap05_validacao}
\input{capitulos/cap06_conclusao}
...
%% ---- ANEXOS ----
\appendix
\input{anexos/anx01_realm}
\input{anexos/anx02_utilizadores}
<<<<<<< HEAD
=======
\input{anexos/anx03_demo}
